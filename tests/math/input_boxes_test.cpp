...
//
// The pure ImGui keyboard-focus reconciliation DECISION moved to the shared bridge
// substrate; its unit tests now live in tests/bridge/focus_reconcile_test.cpp
// (decide_focus_reconcile over a FocusRegistry). Z09 no longer owns that logic.
